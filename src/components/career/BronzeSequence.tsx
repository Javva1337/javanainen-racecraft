...
const COPY = {
  sv: {
    ...
    of: "av",
    medal: "VM-brons",
    note: "VM avgörs på hela veckans sammanlagda poäng, så trots vinsten i finalracet räckte det till tredje plats totalt. Samma vecka: 5:a med Sverige i lagtävlingen Nations Cup, där en miss vid ett förarbyte i depån kostade chansen till segern.",
  },
  en: {
